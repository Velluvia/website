...
export const products: Product[] = [
  ...
  },
  {
    ...
    comingSoon: true,
    description:
      "A full-size golf umbrella built to actually hold up in UK weather, finished with the Velluvia mark in gold foil beneath the canopy — the kind of practical, well-made gift that gets used on the very first rainy day.",
    details: [
